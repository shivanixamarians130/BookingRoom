...
namespace RoomBooking.Helpers
{
    class BookingHelper
    {
        ...
        //    List<BookingModel> MeetingList = new List<BookingModel>();
        //    await Task.Delay(1000);
        //    //    if (MeetingList.Count > 0)
        //    //      return MeetingList;
        //    MeetingList.Clear();
        //    MeetingList.Add(new BookingModel() { start = DateTime.Now, end = DateTime.Now.AddMinutes(1), purpose = "Xamarin1" });
        //    //  MeetingList.Add(new BookingModel() { start = DateTime.Now.AddMinutes(1), end = DateTime.Now.AddMinutes(2), purpose = "Xamarin2" });
        //    MeetingList.Add(new BookingModel() { start = DateTime.Now.AddMinutes(2), end = DateTime.Now.AddMinutes(3), purpose = "Xamarin3" });
        //    MeetingList.Add(new BookingModel() { start = DateTime.Now.AddMinutes(17), end = DateTime.Now.AddMinutes(20), purpose = "Xamarin5" });
        //    MeetingList.Add(new BookingModel() { start = DateTime.Now.AddMinutes(20), end = DateTime.Now.AddMinutes(30), purpose = "Xamarin6" });
        //    return MeetingList;
        //}
